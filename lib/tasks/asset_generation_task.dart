...
///
/// This task can build helper YAML configs, pad splash images for Android 12,
/// and execute the bitmaps generation steps when both icon and splash assets are
/// required together.
class AssetGenerationTask extends RebrandTask {
  ...
  Future<void> execute() async {
    ...
    if (config.iconPath != null) {
      await writeAndRunIcons(config, config.iconPath!);
    }
  }
